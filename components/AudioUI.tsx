...
export const BG_TOP = '#315683'
export const BG_MID = '#244670'
export const BG_BOT = '#1c3b61'
...
export const couleurBg: Record<string, string> = {
    Aqeedah: '#e9eff6', Fiqh: '#f6eed6', Hadith: '#e6efe8',
    'Tafsir & Sciences du Coran': '#f6e7eb', Seerah: '#f7eae2',
    Invocations: '#e3efee', 'Éthique & Bons comportements': '#eeeaf5',
    'Séries de cours': '#f0e9dd',
}
export const couleurTxt: Record<string, string> = {
    Aqeedah: '#2c5382', Fiqh: '#96751c', Hadith: '#2f6b4f',
    'Tafsir & Sciences du Coran': '#93374f', Seerah: '#a2552d',
    Invocations: '#2b6b6b', 'Éthique & Bons comportements': '#6d5296',
    'Séries de cours': '#7a5b3a',
}
