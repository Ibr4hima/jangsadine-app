...
function IcoCoran({ size = 16, color = colors.bleu }: IcoProps) {
  // Mushaf ouvert posé sur un rihal (support en X) — dessiné dans la grille
  // Material Symbols (viewBox 0 -960 960 960) pour matcher les autres icônes.
  return (
    <Svg width={size} height={size} viewBox="0 -960 960 960">
      {/* page gauche */}
      <Path d="M480-590C360-650 240-680 150-690L150-560 480-440Z" fill={color} />
      {/* page droite */}
      <Path d="M480-590C600-650 720-680 810-690L810-560 480-440Z" fill={color} />
      {/* montant gauche du support */}
      <Path d="M377-450 403-490 673-310 647-270Z" fill={color} />
      {/* montant droit du support */}
      <Path d="M583-450 557-490 287-310 313-270Z" fill={color} />
    </Svg>
  )
}
