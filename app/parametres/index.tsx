...
function IconMail({ size = 18, color = colors.bleu }: { size?: number, color?: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 -960 960 960">
      <Path d="M160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h640q33 0 56.5 23.5T880-720v480q0 33-23.5 56.5T800-160H160Zm320-280 320-200v-80L480-520 160-720v80l320 200Z" fill={color} />
    </Svg>
  )
}
          ...
          <View style={{ gap: spacing.sm }}>
            ...
            <PressableScale onPress={contacter} style={{
              ...
              <View style={{
                ...
                <IconMail size={19} color={colors.bleu} />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={{ fontFamily: typography.fontFamily.semibold, fontSize: typography.size.base, color: colors.texte }}>
                  Contact
